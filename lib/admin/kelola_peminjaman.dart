        ...
        builder: (context, snapshot) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              final isOverdue = tglKembali.isBefore(DateTime.now());
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: _buildInfoCard(
                                    ...
                                    isOverdue ? const Color(0xFFFF6B6B) : const Color(0xFF14B8A6),
                                  ),
                                ),
                              ],
                            ),
...
class _DetailPeminjamanPageState extends State<DetailPeminjamanPage> {
  ...
  @override
  Widget build(BuildContext context) {
    final isOverdue = widget.tglKembali.isBefore(DateTime.now());
    final daysRemaining = widget.tglKembali.difference(DateTime.now()).inDays;
                    ...
                    children: [
                      Expanded(
                        child: _buildModernInfoCard(
                          ...
                          isOverdue ? const Color(0xFFFF6B6B) : const Color(0xFF667EEA),
                        ),
                      ),
                      const SizedBox(width: 12),
                      Expanded(
